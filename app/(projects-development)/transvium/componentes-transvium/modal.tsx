...
export default function Modal() {
  ...
  return (
    <div>
      ...
      <button
        onClick={openModal}
        className='font-satoshi-medium justify-self-start bg-[rgba(24,24,27,0.62)] p-[0.8rem] mt-[1rem] rounded-[3.5px] backdrop-blur-[8px] outline outline-1 xs:outline-1 outline-zinc-800 lg:hover:bg-zinc-800 text-zinc-100 xs:active:bg-zinc-800 flex gap-2'
      >
